...
This is a custom Gemini prompt + prefill combo built for **JanitorAI**. It's tuned to keep Gemini in-character, push prose toward something that actually reads like a story instead of a synopsis, and let you goon to your AI waifus the way God intended.

Drop it in once, forget about it.
...
- **Responses cut short?** Raise max tokens in the API settings.
- **"Sorry, I can't help with that."** Double-check prefill is enabled and the text is actually saved.
